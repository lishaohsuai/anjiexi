...
function datacharacter(){
	...
	temp.sort();
	if(temp[3] == valueD){// D高
		characterT.innerHTML = "D高：力量型！—具有领导能力\
特点：外向、行动者、乐观。喜欢做主、行动力强、行动速度、思考力稍弱、喜欢做目标、不达目的不罢休、充满自信、意志坚定、有活力、做事主动、不易气馁、是推动别人行动的人、粗线条、不容易适应环境（不过由于行动力很强 所以往往做事会有很大成就 ）。 \
优点：是一个坚定果敢的人，酷好变化，喜欢控制，干劲十足，独立自主，超级自信。在工作方面，你是一个务实和讲究效率的人，目标明确，眼光全面，组织力强，行动迅速，解决问题不过夜，果敢坚持到底，在反对声中成长。但是，因为过于强调结果，你往往容易忽视细节，处理问题不够细致。\
缺点：爱管人、喜欢支使他人的特点使得你能够带动团队进步，但也容易激起同事的反感。\
不易看到别人的需求，只看到自己的需求 做错事后很容易原谅自己。由于你比较不会顾及别人的感受，所以显得粗鲁、霸道、没有耐心、穷追不舍、不会放松。你不习惯与别人进行感情上的交流，不会恭维人，不喜欢眼泪，匮乏同情心。 固执、易争吵、好斗、说话极易伤害别人、具有强迫性、很容易支配别人、无耐性、专横、经常人际关系差 （这类人总觉得自己是对的，不太需要朋友，并且这类人天生行动力强，但是即使是正确的事情，也因为性格问题，说话伤害到别人，而得不到别人的支持和认同）。\
注意点：这类型严重者会很独断、霸道、容易让别人感到压力、相处很累。\
自我规划：  1。减轻对别人的压力 学会放松 要缓和 2。尝试接受别人的号召和意见 尝试耐心和低调 3。停止争吵让别人也感觉到放松  4。学习包容 学会道歉 学会坦然接受自己的错误 放开胸怀（当一个力量型的人学会承认错误 那么他便成功了）   \
"
		if(temp[0] == valueI){//高D  低I
			characterP.innerHTML = "高d  低i: 效率\
...
"
			...
			characterP.innerHTML = "高d  低s：行动、自我激励\
...
"
		...
		characterT.innerHTML = "I高  活泼型！—团队活动组织人\
特点：外向、多言、乐观。一群人里面说话最多的,天生希望成为注意力的中心，具有很强的好奇心、热情、热心具有表达能力、精力充沛、具有干劲（但是却缺乏毅力 所以常常这干干 那干干）、好表现、粗线条、轻许诺（因为热心所以常常答应别人 但是由于记忆差 所以常常答应后就忘记了） 、以自己的快乐为主。\
优点：在工作方面，你是一个热情的推动者，总有新主意，色彩丰富，说干就干，能够鼓励和带领他人一起积极投入工作。在人际关系方面，你容易交上朋友，朋友也多。你关爱朋友，也被朋友称赞。你爱当主角，爱受欢迎喜欢控制谈话内容。\
缺点：以自己为中心、独霸主题、爱打断别人的谈话、不注意记忆、变化无常。这类人易交朋友，但深切的朋友却不多，喜好多却不精，缺乏毅力。容易生气，爱抱怨，大嗓门，不成熟。遇到困难容易失去信心，杂乱无章，做事不彻底，爱走神儿，爱找借口。\
...
Self-confidence－自信：高 Influence 和 低 Compliance，在分析表中发现显示高影响及低服从的DISC子特征。「自信」分析表所表示的人极少会缺乏自信，而且几乎在任何社交场合都能处之泰然。他们很容易和陌生人打成一片，也不怕主动与人接触。他们有时会变得过度自信，而造成他们冲动行事。"
	 	...
	 	characterT.innerHTML = "S高和平型！—知足而不愿前进的人\
特点：内向、旁观者、悲观。性格低调、易相处、很轻松、平和、无异议、耐心、适应力强、无攻击性、很好的聆听者、具有外交手段（说话绕弯 不直接）、人际关系好（和事老）、所以朋友很多、不爱生气。 \
优点：是一个温和主义者，悠闲，平和，有耐心，感情内藏，待人和蔼，乐于倾听，遇事冷静，随遇而安。在工作方面，你能够按部就班地管理事务，胜任工作并能够持之以恒。你奉行中庸之道，平和可亲，一方面习惯于避免冲突，另一方面也能处变不惊。\
缺点：不容易兴奋、拒绝改变、喜欢一成不变、目标感不强、看似懒惰、不愿承担责任、回避压力、沉默（不愿意沟通 即使内心波涛汹涌...所以这类型的爱人，常常都不会说：我爱你） 马虎、无主见（需要力量型的人 给于指导，但不要施加压力），不善于做决定。总是慢吞吞的，很难被鼓动，懒惰，马虎，得过且过。由于害怕承担风险和责任，宁愿站在一边旁观。很多时候，你总是焉有主意，有话不说，或折衷处理。\
切入点：和这类型的人交往 一定要鼓励他 促进他 注意点：这类型过分时会毫无主见 做事漫不经心 \
自我规划： 1.让自己快乐起来 给自己尝试新鲜的事物和思想 2.明确生活的责任 不要得过且过  3.有意识接受督促（找个力量型或完美型） 4.多表达、沟通。\
";
		if(temp[0] == valueD){//高S  低D
			characterP.innerHTML = "高s  低d—耐心\
...
"
			...
			characterP.innerHTML ="高s  低i—深思熟虑\
...
"
			...
			characterP.innerHTML = "高s  低c—执着、高忠诚性\
...
"
		...
		characterT.innerHTML = "C高  完美型！—专业性人才\
特点：内向、思考者、悲观以思考为主。深思熟虑、严肃、有目标并且目标感很强、追求完美、有艺术天分、沉闷、关注细节、完美主义、高标准、想得多但做得少、做事前一定要先想个计划、有条理、有组织、交友慎重（但一旦交往 就会很忠诚的对待朋友）、关心别人、为别人牺牲是自己的意愿 （所以这类型的人一生一定有几个特别好的朋友 一辈子的朋友那种）情感丰富容易感动、也容易受伤。\
优点：是一个性格深沉的人，严肃认真，目的性强，善于分析，愿意思考人生与工作的意义，喜欢美丽，对他敏感，理想主义。在工作方面，你是一个完美主义者，高标准，计划性强，注重细节，讲究条理，整洁，能够发现问题并制订解决问题的办法，喜欢图表和清单，坚持己见，善始善终。\
缺点：行动力弱、优柔寡断、容易抑郁（常常是因为要求过高了、当达不到时候就会很失望）、容易自惭自愧、悲观、天生消极、易受环境影响、情绪化。你也很可能是一个优柔寡断的人，习惯于收集信息资料和做分析，却很难投入到实际运作的工作中来。你容易自我否定，因此需要别人的认同。同时，你也习惯于挑剔别人，不能忍受别人的工作做不好。怀疑别人，喜欢批评人事，却不喜欢别人的反对。\
注意点：这类型的人太容易思考、过分时会情绪低落。\
切入点：如果想和着类型的人交往，一定要先打动他，但是不要进攻尽力，要一点一点的建立信任和感情。这类型的人一旦认同你后，会很忠诚、忠心。\
自我规划： 1。要快乐起来（没人喜欢郁闷的人） 2。不要太容易受伤害 不要太敏感  3。 不要把时间都用来规划上面 而不去行动发  4，不要那么高标准的要求别人 他不是你 要放松下来 要去发现别人的优点 ";
		if(temp[0] == valueD){//高C 低D
			characterP.innerHTML = "高c 低d—高配合度\
